...
public class FlappyAirplane extends JPanel implements ActionListener, KeyListener {
    int boardWidth = 360;
    int boardHeight = 640;
    ...
    FlappyAirplane() {
        ...
        birdImg = new ImageIcon(getClass().getResource("./airoplane.png")).getImage();
    ...
    boolean collision(Bird a, Pipe b) {
        // Added small buffer (5 pixels) to make collision detection more forgiving
